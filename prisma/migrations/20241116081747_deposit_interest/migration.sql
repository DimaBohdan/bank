...
INSERT INTO "new_Deposit" ("accountId", "amount", "createdAt", "deposittemplateId", "id", "userId") SELECT "accountId", "amount", "createdAt", "deposittemplateId", "id", "userId" FROM "Deposit";
DROP TABLE "Deposit";
